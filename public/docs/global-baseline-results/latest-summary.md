...
**Run ID:** 2026-05-07T14-02-39-701Z
**Run date:** 2026-05-07T14:02:39.701Z
**Exchange filter:** ALL
...
| Metric | Count | % |
|--------|-------|---|
| Entered data path | 30 | 100.0% |
| Filing fetched | 23 | 76.7% |
| Structured data found | 0 | 0.0% |
| Narrative parsing succeeded | 19 | 63.3% |
| **Materially specific output** | **0** | **0.0%** |
| Fallback-dominant output | 30 | 100.0% |
...
**Average confidence score: 21 | Grade distribution: A:0 B:0 C:0 D:8 F:22**
...
|--------|----------|---------|-------|---------|------|------------|-----------|-----------|------------------------|----------|-------|-------|-------|
| PETR3 | BVMF | Brazil | ✅ | ✅ | dfp_xml | ❌ | ✅ | 1 | FALLBACK/FALLBACK/MODELED/FALLBACK | ❌ | 26 | F |  |
...
| VALE3 | BVMF | Brazil | ✅ | ✅ | dfp_xml | ❌ | ✅ | 1 | FALLBACK/FALLBACK/MODELED/FALLBACK | ❌ | 26 | F |  |
...
| RIO.L | LSE | United Kingdom | ✅ | ✅ | annual_report_html | ❌ | ✅ | 1 | FALLBACK/FALLBACK/MODELED/FALLBACK | ❌ | 26 | F |  |
