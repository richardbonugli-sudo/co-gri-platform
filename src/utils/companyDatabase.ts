...
export interface Company {
  ...
  /** For native-exchange listings that also have a US ADR, the ADR ticker */
  adrEquivalent?: string;
  /** Special classification for non-operating-company listings */
  companyType?: 'operating' | 'commodity_trust' | 'gdr';
  /** Yahoo Finance-compatible symbol (with exchange suffix & zero-padding) */
  yahooTicker?: string;
}
...
const companies: Company[] = [
  ...
  // ── Global Baseline Expansion (Phase 1) ────────────────────────────────────
  // Native-exchange listings for non-US companies (isADR: false).
  // yahooTicker reflects the correct Yahoo Finance symbol with suffix/padding.

  // BVMF (Brazil) — Yahoo Finance suffix: .SA
  { ticker: 'CMIG3', name: 'Cia Energetica de Minas Gerais - Cemig', exchange: 'BVMF', country: 'Brazil', sector: 'Utilities', isADR: false, yahooTicker: 'CMIG3.SA', aliases: ['Cemig', 'CMIG3'] },
  { ticker: 'PETR3', name: 'Petroleo Brasileiro S.A. - Petrobras', exchange: 'BVMF', country: 'Brazil', sector: 'Energy', isADR: false, adrEquivalent: 'PBR', yahooTicker: 'PETR3.SA', aliases: ['Petrobras', 'PETR3'] },
  { ticker: 'RECV3', name: 'Petroreconcavo S.A.', exchange: 'BVMF', country: 'Brazil', sector: 'Energy', isADR: false, yahooTicker: 'RECV3.SA', aliases: ['Petroreconcavo', 'RECV3'] },
  { ticker: 'VALE3', name: 'Vale S.A.', exchange: 'BVMF', country: 'Brazil', sector: 'Basic Materials', isADR: false, adrEquivalent: 'VALE', yahooTicker: 'VALE3.SA', aliases: ['Vale', 'VALE3'] },

  // HKG (Hong Kong) — Yahoo Finance suffix: .HK with zero-padding to 4 digits
  { ticker: '14', name: 'Hysan Development Co. Ltd.', exchange: 'HKG', country: 'Hong Kong', sector: 'Real Estate', isADR: false, yahooTicker: '0014.HK', aliases: ['Hysan', 'Hysan Development'] },
  ...
  { ticker: '315', name: 'SmarTone Telecommunications Holdings Ltd.', exchange: 'HKG', country: 'Hong Kong', sector: 'Communication Services', isADR: false, yahooTicker: '0315.HK', aliases: ['SmarTone'] },
  { ticker: '517', name: 'COSCO Shipping International (Hong Kong) Co. Ltd.', exchange: 'HKG', country: 'China', sector: 'Industrials', isADR: false, yahooTicker: '0517.HK', aliases: ['COSCO Shipping International'] },
  { ticker: '857', name: 'PetroChina Co. Ltd.', exchange: 'HKG', country: 'China', sector: 'Energy', isADR: false, yahooTicker: '0857.HK', aliases: ['PetroChina'] },

  // JSE (South Africa) — Yahoo Finance suffix: .JO
  { ticker: 'SOL', name: 'Sasol Ltd.', exchange: 'JSE', country: 'South Africa', sector: 'Energy', isADR: false, yahooTicker: 'SOL.JO', aliases: ['Sasol'] },
  { ticker: 'SSW', name: 'Sibanye Stillwater Limited', exchange: 'JSE', country: 'South Africa', sector: 'Basic Materials', isADR: false, yahooTicker: 'SSW.JO', aliases: ['Sibanye Stillwater', 'Sibanye'] },

  // LSE (United Kingdom) — Yahoo Finance suffix: .L
  // Note: RIO.L and SHEL.L are the native LSE listings; RIO and SHEL (no suffix) are their US ADR equivalents already in the database above.
  ...
  { ticker: 'HSBK', name: 'Halyk Bank of Kazakhstan JSC', exchange: 'LSE', country: 'Kazakhstan', sector: 'Financial Services', isADR: false, companyType: 'gdr', yahooTicker: 'HSBK.L', aliases: ['Halyk Bank', 'HSBK'] },
  { ticker: 'RIO.L', name: 'Rio Tinto plc', exchange: 'LSE', country: 'United Kingdom', sector: 'Basic Materials', isADR: false, adrEquivalent: 'RIO', yahooTicker: 'RIO.L', aliases: ['Rio Tinto LSE', 'RIO.L'] },
  { ticker: 'SHEL.L', name: 'Shell Plc', exchange: 'LSE', country: 'United Kingdom', sector: 'Energy', isADR: false, adrEquivalent: 'SHEL', yahooTicker: 'SHEL.L', aliases: ['Shell LSE', 'SHEL.L'] },

  // SGX (Singapore) — Yahoo Finance suffix: .SI
  ...
  { ticker: 'F34', name: 'Wilmar International Limited', exchange: 'SGX', country: 'Singapore', sector: 'Consumer Cyclical', isADR: false, yahooTicker: 'F34.SI', aliases: ['Wilmar International', 'Wilmar'] },
  { ticker: 'J36', name: 'Jardine Matheson Holdings Ltd.', exchange: 'SGX', country: 'Singapore', sector: 'Industrials', isADR: false, yahooTicker: 'J36.SI', aliases: ['Jardine Matheson', 'Jardine'] },
  { ticker: 'NS8U', name: 'Hutchison Port Holdings Trust', exchange: 'SGX', country: 'Singapore', sector: 'Industrials', isADR: false, yahooTicker: 'NS8U.SI', aliases: ['Hutchison Port Holdings'] },
  { ticker: 'P8Z', name: 'Bumitama Agri Ltd.', exchange: 'SGX', country: 'Singapore', sector: 'Consumer Cyclical', isADR: false, yahooTicker: 'P8Z.SI', aliases: ['Bumitama Agri', 'Bumitama'] },
  { ticker: 'TPED', name: 'PTT Exploration and Production Public Company Limited', exchange: 'SGX', country: 'Thailand', sector: 'Energy', isADR: false, yahooTicker: 'TPED.SI', aliases: ['PTTEP', 'PTT Exploration'] },

  // TAI (Taiwan) — Yahoo Finance suffix: .TW
  { ticker: '2603', name: 'Evergreen Marine Corporation (Taiwan) Ltd.', exchange: 'TAI', country: 'Taiwan', sector: 'Industrials', isADR: false, yahooTicker: '2603.TW', aliases: ['Evergreen Marine', 'Evergreen'] },
  { ticker: '2609', name: 'Yangming Marine Transport Corp.', exchange: 'TAI', country: 'Taiwan', sector: 'Industrials', isADR: false, yahooTicker: '2609.TW', aliases: ['Yangming Marine', 'Yangming'] },

  // TSE (Canada) — Yahoo Finance suffix: .TO (special case: U.UN → U-UN.TO)
  { ticker: 'PHYS', name: 'Sprott Physical Gold Trust', exchange: 'TSE', country: 'Canada', sector: 'Commodities', isADR: false, companyType: 'commodity_trust', yahooTicker: 'PHYS.TO', aliases: ['Sprott Gold', 'PHYS'] },
  ...
  { ticker: 'PSLV', name: 'Sprott Physical Silver Trust', exchange: 'TSE', country: 'Canada', sector: 'Commodities', isADR: false, companyType: 'commodity_trust', yahooTicker: 'PSLV.TO', aliases: ['Sprott Silver', 'PSLV'] },
  { ticker: 'PXT', name: 'Parex Resources Inc.', exchange: 'TSE', country: 'Canada', sector: 'Energy', isADR: false, yahooTicker: 'PXT.TO', aliases: ['Parex Resources', 'Parex'] },
  { ticker: 'SPPP', name: 'Sprott Physical Platinum and Palladium Trust', exchange: 'TSE', country: 'Canada', sector: 'Commodities', isADR: false, companyType: 'commodity_trust', yahooTicker: 'SPPP.TO', aliases: ['Sprott Platinum Palladium', 'SPPP'] },
  { ticker: 'U.UN', name: 'Sprott Physical Uranium Trust', exchange: 'TSE', country: 'Canada', sector: 'Commodities', isADR: false, companyType: 'commodity_trust', yahooTicker: 'U-UN.TO', aliases: ['Sprott Uranium', 'U.UN'] },
];
 ...
 * Deduplication key is ticker+exchange so that native listings (e.g. RIO.L)
 * and their US ADR counterparts (e.g. RIO) are both preserved.
 */
export function getAllCompanies(): Company[] {
  const seen = new Set<string>();
  return companies.filter(c => {
    const key = `${c.ticker.toUpperCase()}|${c.exchange.toUpperCase()}`;
...
/**
 * Compute the Yahoo Finance-compatible ticker symbol for a given ticker and exchange.
 * Handles zero-padding for HKG numeric tickers and the U.UN → U-UN.TO special case.
 */
export function getYahooFinanceTicker(ticker: string, exchange: string): string {
  // If the company record already has a pre-computed yahooTicker, prefer that.
  const record = companies.find(
    c => c.ticker.toUpperCase() === ticker.toUpperCase() &&
         c.exchange.toUpperCase() === exchange.toUpperCase()
  );
  if (record?.yahooTicker) return record.yahooTicker;
  ...
  switch (exchange.toUpperCase()) {
    ...
    case 'HKG':
    case 'HKEX': {
      // Zero-pad numeric tickers to 4 digits
    ...
    case 'LSE':
      // Already suffixed tickers (e.g. RIO.L, SHEL.L) pass through unchanged
    ...
    case 'TSE':
    case 'TSX': {
      // Special case: U.UN → U-UN.TO (Yahoo Finance uses hyphen)
      if (ticker === 'U.UN') return 'U-UN.TO';
      // Already suffixed TSX tickers (e.g. TOU.TO) pass through unchanged
