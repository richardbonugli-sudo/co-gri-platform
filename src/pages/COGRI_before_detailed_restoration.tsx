      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        ...
        <Card className="max-w-4xl mx-auto mb-8 bg-[#0f1e2e] border-gray-700">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">Enter a stock ticker symbol to calculate its geopolitical risk exposure with three-tier fallback analysis</CardDescription>
          <CardContent>
                ...
                {SUPPORTED_COUNTRIES.map((country) => (
                  <div key={country.name} className="bg-[#1a2332] p-3 rounded-lg border border-gray-700">
                    ...
                    {country.tickerSuffix && (
                      <div className="text-gray-500 text-xs mt-1">{country.tickerSuffix}</div>
                    )}
                  </div>
                ))}
              </div>
